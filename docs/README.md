...
The deployment url is: [https://pglez82.github.io/dede_es4a/](https://pglez82.github.io/dede_es4a/).
...
If we want to deploy it to GitHub pages, so it is accesible via [https://pglez82.github.io/dede_es4a/](https://pglez82.github.io/dede_es4a/) we need to execute `npm run deploy`.
